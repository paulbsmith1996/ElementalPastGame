...
namespace ElementalPastGame.SpacesManagement.Spaces.Houses
{
    public class House2Space : Space, ISpace
    {
        ...
        {
            SetChunkToTile(TileFactory.TileWithBackground(TextureMapping.Blank, true), 0, 0, SpaceConstants.HOUSE_WIDTH + 1, SpaceConstants.HOUSE_HEIGHT + 1);
            SetChunkToTile(TileFactory.TileWithBackground(TextureMapping.HouseFloor), 1, 1, SpaceConstants.HOUSE_WIDTH, SpaceConstants.HOUSE_HEIGHT);

            SetTileAtLocation(TileFactory.PortalTileWithBackground(TextureMapping.HouseMat, Spaces.OVERWORLD, 820, 870), SpaceConstants.HOUSE_START_X, SpaceConstants.HOUSE_START_Y);
            ...
            RegisterGameObject(villager1, null);
        }
    }
}
